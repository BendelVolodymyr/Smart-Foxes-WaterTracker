...
`,Il=e=>e.water.waterDayList,Ll=e=>e.water.waterMonthList,Bl=e=>e.water.waterRate,At=()=>{const e=It(Il),t=It(Ll),n=It(Bl);return{waterDayList:e,waterMonthList:t,waterRate:n}},zl=()=>{const[e,t]=d.useState(new Date),[n,r]=d.useState(e.getMonth()),[o,i]=d.useState(null),s=mt(),a=At().waterMonthList,c=()=>{i(null)},u=!!o,f=u?"simple-popover":void 0;d.useEffect(()=>{const b=An(e),m=Wn(e);r(e.getMonth()),s(ro({startDate:b,endDate:m}))},[n,s,e]);const h=(b,m)=>{t(m),i(b.currentTarget)},p=a&&a.find(b=>{const[m]=b.date.split(",");return parseInt(m)===e.getDate()});return l.jsxs(Rl,{children:[l.jsxs(_l,{children:[l.jsx("h3",{children:"Month"}),l.jsx(Hi,{selectedDate:e,setSelectedDate:t,setCurrentMonth:r})]}),l.jsx(Dl,{children:Ao({start:An(e),end:Wn(e)}).map((b,m)=>{const x=b.getDate(),P=a.find(w=>{const[g]=w.date.split(",");return parseInt(g)===x}),S=P?P.percentagePerDay:null;return l.jsxs(Wl,{onClick:w=>h(w,b),children:[l.jsx(Al,{percentage:S,children:l.jsx(Fl,{children:x})}),l.jsxs(Nl,{children:[S||0,"%"]})]},m)})}),l.jsx(Tl,{id:f,open:u,anchorEl:o,onClose:c,anchorOrigin:{vertical:"top",horizontal:"left"},transformOrigin:{vertical:"bottom",horizontal:"right"},children:l.jsx(jl,{selectedDate:e,selectedDayData:p})})]})},Hl=y.div`
display: flex;
flex-direction:column;
