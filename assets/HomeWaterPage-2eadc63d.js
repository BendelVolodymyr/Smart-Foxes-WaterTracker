...
`,to=({selectedDate:e,selectedDayData:t})=>{const n=kt(e,"MMMM"),r=e.getDate(),o=He().user.waterRate,s=o?(o/1e3).toFixed(1):"0",i=t?(t.waterRate/1e3).toFixed(1):s,d=t?t.percentagePerDay:"0",u=t?t.totalPortions:"0";return a.jsxs(Jr,{children:[a.jsxs(Zr,{children:[" ",r,", ",n]}),a.jsxs(eo,{children:[a.jsxs(Oe,{children:["Daily Norma: ",a.jsxs("span",{children:[i," L"]})]}),a.jsxs(Oe,{children:["Fulfillment of the daily norm: ",a.jsxs("span",{children:[d,"%"]})]}),a.jsxs(Oe,{children:["How many servings of water: ",a.jsx("span",{children:u})]})]})]})},no=c.div`
  display: flex;
  flex-direction: column;
  width: 100%;
`,ro=c.div`
...
`,Yo=({id:e})=>{const{closeModal:t}=l.useContext(Pe),n=me(),r=async()=>{await n(Lt(e)),t(),n(Ae())};return a.jsxs(zo,{children:[a.jsx("h3",{children:"Delete entry"}),a.jsx("p",{children:"Are you sure you want to delete the entry?"}),a.jsxs(Lo,{children:[a.jsx(Ho,{type:"button",onClick:()=>t(),children:"Cancel"}),a.jsx(Ao,{type:"submit",onClick:r,children:"Delete"})]})]})};function Bo(e){return xt({tag:"svg",attr:{viewBox:"0 0 24 24"},child:[{tag:"path",attr:{d:"M11.75 4.5a.75.75 0 0 1 .75.75V11h5.75a.75.75 0 0 1 0 1.5H12.5v5.75a.75.75 0 0 1-1.5 0V12.5H5.25a.75.75 0 0 1 0-1.5H11V5.25a.75.75 0 0 1 .75-.75Z"},child:[]}]})(e)}const Io=c.div`
  display: flex;
  flex-direction: column;
  gap: 24px;
  align-items: flex-start;
...
`;function ca(e){const t=e.getFullYear(),n=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0");return`${t}-${n}-${r}`}const Tt=({portion:e})=>{const t=me(),[n,r]=l.useState(e?e.waterVolume:0),[o,s]=l.useState(we(e?e.dateAdded:new Date)),{closeModal:i}=l.useContext(Pe),{waterDayList:d}=Ye(),u=d,f=x=>{const w=parseFloat(x.target.value);if(w>3e3){alert("не більше 3000 мл");return}r(w)},m=x=>{switch(x.currentTarget.id){case"increment":r(w=>w+50);break;case"decrement":r(w=>w>0?w-50:0);break}},g=async x=>{x.preventDefault();const P=ca(new Date)+"T"+o,p=new Date(P).toISOString();if(e){const h={id:e._id,date:p,waterVolume:n};await t(At(h)),i(),t(Ae())}else{if(u?u.find(k=>{k.dateAdded}):p){alert("Не можна в один той самий час"),s("");return}const y={waterVolume:n,date:p};try{if(!(await t(Yt(y))).error)i(),r(0),s("");else throw new Error}catch(k){console.error(k),alert("Something went wrong"),i()}}},v=e?"Edit the entered amount of water":"Add water",M=e?"Correct entered data: ":"Choose a value:";return a.jsxs(Io,{children:[a.jsxs(_o,{children:[" ",v]}),e&&a.jsxs(Pt,{children:[a.jsx(Et,{}),a.jsx(Mt,{children:`${e.waterVolume} ml `}),a.jsx("span",{children:we(e.dateAdded,!0)})]}),a.jsxs(Vo,{children:[a.jsx(qo,{children:M}),a.jsxs(Go,{children:[a.jsx(Qo,{children:"Amount of water:"}),a.jsxs(Uo,{children:[a.jsx(ut,{onClick:m,id:"decrement",children:a.jsx(sa,{})}),a.jsxs(ra,{children:[" ",n||0," L"]}),a.jsx(ut,{onClick:m,id:"increment",children:a.jsx(aa,{})})]})]})]}),a.jsxs(Xo,{children:[a.jsx(Ko,{children:"Recording time:"}),a.jsx(Jo,{type:"time",value:o,onChange:x=>s(x.target.value)})]}),a.jsxs(Zo,{children:[a.jsx(ea,{children:"Enter the value of the water used:"}),a.jsx(ta,{type:"number",value:n,onChange:f,placeholder:"0"})]}),a.jsxs(na,{children:[a.jsxs(ia,{children:[" ",n||0," Ml"]}),a.jsx(oa,{onClick:g,children:"Save"})]})]})},la=({handleAddWaterClick:e})=>{const{openModal:t}=l.useContext(Pe),n=Ye().waterDayList,r=me();l.useEffect(()=>{r(Ae())},[r]);const o=i=>{t(a.jsx(a.Fragment,{children:a.jsx(Yo,{id:i})}))},s=i=>{t(a.jsx(a.Fragment,{children:a.jsx(Tt,{portion:i})}))};return a.jsxs(Do,{children:[a.jsx("h3",{children:"Today"}),n&&n.length>0&&a.jsx($o,{children:n.map(i=>a.jsxs("li",{children:[a.jsxs(Pt,{children:[a.jsx(Et,{}),a.jsx(Mt,{children:`${i.waterVolume} ml `}),a.jsx("span",{children:we(i.dateAdded,!0)})]}),a.jsxs(Oo,{children:[a.jsx(Ro,{onClick:()=>s(i),children:a.jsx(Co,{})}),a.jsx(Fo,{onClick:()=>o(i._id),children:a.jsx(Wo,{})})]})]},i._id))}),a.jsxs(No,{onClick:e,children:[a.jsx(St,{})," Add water"]})]})},da=c.div`
...
`,La=({handleAddWaterClick:e})=>a.jsxs(Na,{children:[a.jsx(Fa,{type:"range"}),a.jsxs(za,{onClick:e,children:[a.jsx(jt,{})," Add water"]})]}),Ba=()=>{const{openModal:e}=l.useContext(Pe),t=()=>{e(a.jsx(a.Fragment,{children:a.jsx(Tt,{})}))};return a.jsxs(ko,{children:[a.jsxs(Po,{children:[a.jsx(Oa,{}),a.jsx(La,{handleAddWaterClick:t})]}),a.jsxs(Mo,{children:[a.jsx(la,{handleAddWaterClick:t}),a.jsx(fo,{})]})]})};export{Ba as default};
