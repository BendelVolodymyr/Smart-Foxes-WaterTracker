...
`,Yo=({id:e})=>{const{closeModal:t}=l.useContext(xe),n=ge(),r=async()=>{await n(Lt(e)),t(),n(Pe())};return a.jsxs(Ho,{children:[a.jsx("h3",{children:"Delete entry"}),a.jsx("p",{children:"Are you sure you want to delete the entry?"}),a.jsxs(Lo,{children:[a.jsx(Ao,{type:"button",onClick:()=>t(),children:"Cancel"}),a.jsx(Io,{type:"submit",onClick:r,children:"Delete"})]})]})};function Bo(e){return wt({tag:"svg",attr:{viewBox:"0 0 24 24"},child:[{tag:"path",attr:{d:"M11.75 4.5a.75.75 0 0 1 .75.75V11h5.75a.75.75 0 0 1 0 1.5H12.5v5.75a.75.75 0 0 1-1.5 0V12.5H5.25a.75.75 0 0 1 0-1.5H11V5.25a.75.75 0 0 1 .75-.75Z"},child:[]}]})(e)}const _o=c.div`
  display: flex;
  flex-direction: column;
  gap: 24px;
  align-items: flex-start;
...
`,La=({handleAddWaterClick:e,calcRange:t})=>a.jsxs(Fa,{children:[a.jsxs(Na,{children:[a.jsx(za,{children:"Today"}),a.jsx(Ra,{type:"range",min:"0",max:"100",value:t||0,readOnly:!0})]}),a.jsxs(Ha,{onClick:e,children:[a.jsx(jt,{})," Add water"]})]}),Ba=()=>{const{openModal:e}=l.useContext(xe),n=me().waterDayList.map(i=>i.percentage);let r=0;n.forEach(i=>{r+=i});const o=()=>{e(a.jsx(a.Fragment,{children:a.jsx(Tt,{})}))},s=()=>{e(a.jsx(a.Fragment,{children:a.jsx(Ca,{})}))};return a.jsxs(Po,{children:[a.jsxs(Mo,{children:[a.jsx(Wa,{handleDailyNormaModal:s}),a.jsx(La,{handleAddWaterClick:o,calcRange:r})]}),a.jsxs(Eo,{children:[a.jsx(da,{handleAddWaterClick:o}),a.jsx(mo,{})]})]})};export{Ba as default};
