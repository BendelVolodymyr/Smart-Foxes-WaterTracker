...
`,Qr=({selectedDate:e,setSelectedDate:t,setCurrentMonth:n,setSelectedDay:r})=>{const o=new Date().getMonth(),s=new Date().getFullYear(),i=Ir(e,Ce(new Date,-12)),d=Yr(e,new Date(s,o,1)),u=kt(e,"MMMM"),f=e.getFullYear(),m=()=>{t(Ce(e,-1)),r(null),n(v=>v-1)},g=()=>{t(Ce(e,1)),r(null),n(v=>v+1)};return a.jsxs(Gr,{children:[a.jsx(dt,{onClick:m,disabled:i,children:a.jsx(Ur,{})}),a.jsx("span",{children:`${u}, ${f}`}),a.jsx(dt,{onClick:g,disabled:d,children:a.jsx(Vr,{})})]})},Xr=c.div`
display: flex;
...
`,Zr=({selectedDate:e,selectedDayData:t})=>{const n=kt(e,"MMMM"),r=e.getDate(),o=Le().user.waterRate,s=o?(o/1e3).toFixed(1):"0",i=t?(t.waterRate/1e3).toFixed(1):s,d=t?t.percentagePerDay:"0",u=t?t.totalPortions:"0";return a.jsxs(Xr,{children:[a.jsxs(Kr,{children:[" ",r,", ",n]}),a.jsxs(Jr,{children:[a.jsxs(Oe,{children:["Daily Norma: ",a.jsxs("span",{children:[i," L"]})]}),a.jsxs(Oe,{children:["Fulfillment of the daily norm: ",a.jsxs("span",{children:[d,"%"]})]}),a.jsxs(Oe,{children:["How many servings of water: ",a.jsx("span",{children:u})]})]})]})},eo=c.div`
  display: flex;
  flex-direction: column;
  width: 100%;
`,to=c.div`
...
`,io=e=>e.water.waterDayList,co=e=>e.water.waterMonthList,lo=e=>e.water.waterRate,Be=()=>{const e=je(io),t=je(co),n=je(lo);return{waterDayList:e,waterMonthList:t,waterRate:n}},uo=()=>{const[e,t]=l.useState(new Date),[n,r]=l.useState(e.getMonth()),[o,s]=l.useState(null),[i,d]=l.useState(null),u=me(),f=Be().waterMonthList,m=()=>{d(null)},g=!!i,v=g?"simple-popover":void 0;l.useEffect(()=>{const w=at(e),b=ot(e);o===null&&u(zt({startDate:w,endDate:b}))},[n,u,e,o]);const M=(w,b)=>{t(b),d(w.currentTarget),s(b.getDate())},x=f&&f.find(w=>{const[b]=w.date.split(",");return parseInt(b)===e.getDate()});return a.jsxs(eo,{children:[a.jsxs(to,{children:[a.jsx("h3",{children:"Month"}),a.jsx(Qr,{selectedDate:e,setSelectedDate:t,setCurrentMonth:r,setSelectedDay:s})]}),a.jsx(no,{children:Yn({start:at(e),end:ot(e)}).map((w,b)=>{const P=w.getDate(),p=f.find(y=>{const[k]=y.date.split(",");return parseInt(k)===P}),h=p?p.percentagePerDay:null;return a.jsxs(ro,{onClick:y=>M(y,w),children:[a.jsx(oo,{percentage:h,children:a.jsx(ao,{children:P})}),a.jsxs(so,{children:[h||0,"%"]})]},b)})}),a.jsx(Fn,{id:v,open:g,anchorEl:i,onClose:m,anchorOrigin:{vertical:"top",horizontal:"left"},transformOrigin:{vertical:"bottom",horizontal:"right"},children:a.jsx(Zr,{selectedDate:e,selectedDayData:x})})]})},ho="/Smart-Foxes-WaterTracker/assets/botleHomeDesk-3ae51194.png",fo="/Smart-Foxes-WaterTracker/assets/botlteHomeDesk2x-9a54d3e4.png",po="/Smart-Foxes-WaterTracker/assets/backgroundHomeTab-586d978e.png",mo="/Smart-Foxes-WaterTracker/assets/BackgroundHomeTab2x-642c3d3e.png",go="/Smart-Foxes-WaterTracker/assets/bottleHomeTab-0bf3952c.png",xo="/Smart-Foxes-WaterTracker/assets/bottleHomeTab2x-ed4a96a1.png",bo="/Smart-Foxes-WaterTracker/assets/backgroundHomeMob-d1e9a558.png",wo="/Smart-Foxes-WaterTracker/assets/backgroundHomeMob2x-089f92e0.png",yo="/Smart-Foxes-WaterTracker/assets/bottleHomeMob-1cd9cdb8.png",vo="/Smart-Foxes-WaterTracker/assets/bottleHomeMob2x-0e2d77ce.png",ko=c.main`
display: flex;
flex-direction:column;
...
`,Bo=({id:e})=>{const{closeModal:t}=l.useContext(Pe),n=me(),r=async()=>{await n(Ht(e)),t(),n(Ae())};return a.jsxs(zo,{children:[a.jsx("h3",{children:"Delete entry"}),a.jsx("p",{children:"Are you sure you want to delete the entry?"}),a.jsxs(Ho,{children:[a.jsx(Lo,{type:"button",onClick:()=>t(),children:"Cancel"}),a.jsx(Ao,{type:"submit",onClick:r,children:"Delete"})]})]})};function Yo(e){return xt({tag:"svg",attr:{viewBox:"0 0 24 24"},child:[{tag:"path",attr:{d:"M11.75 4.5a.75.75 0 0 1 .75.75V11h5.75a.75.75 0 0 1 0 1.5H12.5v5.75a.75.75 0 0 1-1.5 0V12.5H5.25a.75.75 0 0 1 0-1.5H11V5.25a.75.75 0 0 1 .75-.75Z"},child:[]}]})(e)}const Io=c.div`
  display: flex;
  flex-direction: column;
  gap: 24px;
  align-items: flex-start;
...
`;function ca(e){const t=e.getFullYear(),n=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0");return`${t}-${n}-${r}`}const Tt=({portion:e})=>{const t=me(),[n,r]=l.useState(e?e.waterVolume:0),[o,s]=l.useState(we(e?e.dateAdded:new Date)),{closeModal:i}=l.useContext(Pe),{waterDayList:d}=Be(),u=d,f=x=>{const w=parseFloat(x.target.value);if(w>3e3){alert("не більше 3000 мл");return}r(w)},m=x=>{switch(x.currentTarget.id){case"increment":r(w=>w+50);break;case"decrement":r(w=>w>0?w-50:0);break}},g=async x=>{x.preventDefault();const P=ca(new Date)+"T"+o,p=new Date(P).toISOString();if(e){const h={id:e._id,date:p,waterVolume:n};await t(At(h)),i(),t(Ae())}else{if(u?u.find(k=>{k.dateAdded}):p){alert("Не можна в один той самий час"),s("");return}const y={waterVolume:n,date:p};try{if(!(await t(Bt(y))).error)i(),r(0),s("");else throw new Error}catch(k){console.error(k),alert("Something went wrong"),i()}}},v=e?"Edit the entered amount of water":"Add water",M=e?"Correct entered data: ":"Choose a value:";return a.jsxs(Io,{children:[a.jsxs(_o,{children:[" ",v]}),e&&a.jsxs(Pt,{children:[a.jsx(Et,{}),a.jsx(Mt,{children:`${e.waterVolume} ml `}),a.jsx("span",{children:we(e.dateAdded,!0)})]}),a.jsxs(Go,{children:[a.jsx(qo,{children:M}),a.jsxs(Uo,{children:[a.jsx(Qo,{children:"Amount of water:"}),a.jsxs(Vo,{children:[a.jsx(ut,{onClick:m,id:"decrement",children:a.jsx(sa,{})}),a.jsxs(ra,{children:[" ",n||0," L"]}),a.jsx(ut,{onClick:m,id:"increment",children:a.jsx(aa,{})})]})]})]}),a.jsxs(Xo,{children:[a.jsx(Ko,{children:"Recording time:"}),a.jsx(Jo,{type:"time",value:o,onChange:x=>s(x.target.value)})]}),a.jsxs(Zo,{children:[a.jsx(ea,{children:"Enter the value of the water used:"}),a.jsx(ta,{type:"number",value:n,onChange:f,placeholder:"0"})]}),a.jsxs(na,{children:[a.jsxs(ia,{children:[" ",n||0," Ml"]}),a.jsx(oa,{onClick:g,children:"Save"})]})]})},la=({handleAddWaterClick:e})=>{const{openModal:t}=l.useContext(Pe),n=Be().waterDayList,r=me();l.useEffect(()=>{r(Ae())},[r]);const o=i=>{t(a.jsx(a.Fragment,{children:a.jsx(Bo,{id:i})}))},s=i=>{t(a.jsx(a.Fragment,{children:a.jsx(Tt,{portion:i})}))};return a.jsxs(Do,{children:[a.jsx("h3",{children:"Today"}),n&&n.length>0&&a.jsx($o,{children:n.map(i=>a.jsxs("li",{children:[a.jsxs(Pt,{children:[a.jsx(Et,{}),a.jsx(Mt,{children:`${i.waterVolume} ml `}),a.jsx("span",{children:we(i.dateAdded,!0)})]}),a.jsxs(Oo,{children:[a.jsx(Ro,{onClick:()=>s(i),children:a.jsx(Co,{})}),a.jsx(Fo,{onClick:()=>o(i._id),children:a.jsx(Wo,{})})]})]},i._id))}),a.jsxs(No,{onClick:e,children:[a.jsx(St,{})," Add water"]})]})},da=c.div`
