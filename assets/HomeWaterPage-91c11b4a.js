import{_ as b,o as ae,r as d,w as to,h as gr,T as tn,i as $n,k as no,u as g,j as l,l as ke,m as fe,n as ro,C as oo,p as io,q as so,R as Ge,v as ct,x as Mn,y as Tn,z as On,A as ao,b as nn,B as Lt,c as et,D as co,M as rn,E as lo,I as uo,J as fo,G as xr,K as ho,O as Cn}from"./index-1b894b2a.js";import{b as po,a as mo}from"./backgroundElementMainPageDesk2x@2-f75c1b59.js";function me(e){if(typeof e!="object"||e===null)return!1;const t=Object.getPrototypeOf(e);return(t===null||t===Object.prototype||Object.getPrototypeOf(t)===null)&&!(Symbol.toStringTag in e)&&!(Symbol.iterator in e)}function yr(e){if(!me(e))return e;const t={};return Object.keys(e).forEach(n=>{t[n]=yr(e[n])}),t}function ce(e,t,n={clone:!0}){const r=n.clone?b({},e):e;return me(e)&&me(t)&&Object.keys(t).forEach(o=>{o!=="__proto__"&&(me(t[o])&&o in e&&me(e[o])?r[o]=ce(e[o],t[o],n):n.clone?r[o]=me(t[o])?yr(t[o]):t[o]:r[o]=t[o])}),r}const go=Object.freeze(Object.defineProperty({__proto__:null,default:ce,isPlainObject:me},Symbol.toStringTag,{value:"Module"}));function Ve(e){let t="https://mui.com/production-error/?code="+e;for(let n=1;n<arguments.length;n+=1)t+="&args[]="+encodeURIComponent(arguments[n]);return"Minified MUI error #"+e+"; visit "+t+" for the full message."}const xo=Object.freeze(Object.defineProperty({__proto__:null,default:Ve},Symbol.toStringTag,{value:"Module"}));var br={exports:{}},_={};/**
 * @license React
...
`,C0=({id:e})=>{const{closeModal:t}=d.useContext(rn),n=et();console.log(e);const r=()=>{n(lo(e)),t()};return l.jsxs($0,{children:[l.jsx("h3",{children:"Delete entry"}),l.jsx("p",{children:"Are you sure you want to delete the entry?"}),l.jsxs(M0,{children:[l.jsx(T0,{type:"button",onClick:()=>t(),children:"Cancel"}),l.jsx(O0,{type:"submit",onClick:r,children:"Delete"})]})]})},j0=()=>l.jsx("div",{children:" Тут колись буде модалка TodayEditModal"}),R0=({handleAddWaterClick:e})=>{const{openModal:t}=d.useContext(rn),n=Ft().waterDayList,r=et();d.useEffect(()=>{r(uo())},[r]);const o=s=>{t(l.jsx(l.Fragment,{children:l.jsx(C0,{id:s})}))},i=s=>{t(l.jsx(l.Fragment,{children:l.jsx(j0,{portion:s})}))};return l.jsxs(m0,{children:[l.jsx("h3",{children:"Today"}),n&&n.length>0&&l.jsx(g0,{children:n.map(s=>l.jsxs("li",{children:[l.jsxs(x0,{children:[l.jsx(b0,{}),l.jsx(y0,{children:`${s.waterVolume} ml `}),l.jsx("span",{children:u0(s.dateAdded,!0)})]}),l.jsxs(k0,{children:[l.jsx(S0,{onClick:()=>i(s),children:l.jsx(v0,{})}),l.jsx(E0,{onClick:()=>o(s._id),children:l.jsx(w0,{})})]})]},s._id))}),l.jsxs(P0,{onClick:e,children:[l.jsx(Zr,{})," Add water"]})]})},D0=g.div`
...
`,Ou=({TodayWaterList:e,handleAddWaterClick:t})=>(Ft().waterDayList.portions,l.jsxs(Mu,{children:[l.jsx($u,{type:"range",maxValue:100,minValue:0,readOnly:!0}),l.jsxs(Tu,{onClick:t,children:[l.jsx(eo,{})," Add water"]})]})),Ru=()=>{const{openModal:e}=d.useContext(rn),t=()=>{e(l.jsx(l.Fragment,{children:l.jsx(Eu,{})}))};return l.jsxs(a0,{children:[l.jsxs(c0,{children:[l.jsx(nu,{}),l.jsx(Ou,{handleAddWaterClick:t})]}),l.jsxs(l0,{children:[l.jsx(R0,{handleAddWaterClick:t}),l.jsx(Vl,{})]})]})};export{Ru as default};
