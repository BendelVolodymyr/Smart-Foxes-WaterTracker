...
`,Wl=({selectedDate:e,selectedDayData:t})=>{const n=Sr(e,"MMMM"),r=e.getDate(),o=en().user.waterRate,s=o?(o/1e3).toFixed(1):"0",i=t?(t.waterRate/1e3).toFixed(1):s,a=t?t.percentagePerDay:"0",c=t?t.totalPortions:"0";return l.jsxs(Rl,{children:[l.jsxs(Dl,{children:[" ",r,", ",n]}),l.jsxs(_l,{children:[l.jsxs(Gt,{children:["Daily Norma: ",l.jsxs("span",{children:[i," L"]})]}),l.jsxs(Gt,{children:["Fulfillment of the daily norm: ",l.jsxs("span",{children:[a,"%"]})]}),l.jsxs(Gt,{children:["How many servings of water: ",l.jsx("span",{children:c})]})]})]})},Al=y.div`
  display: flex;
  flex-direction: column;
  width: 100%;
`,Nl=y.div`
...
`,M0=({id:e})=>{const{closeModal:t}=d.useContext(tn),n=Ze();console.log(e);const r=()=>{n(so(e)),t()};return l.jsxs(E0,{children:[l.jsx("h3",{children:"Delete entry"}),l.jsx("p",{children:"Are you sure you want to delete the entry?"}),l.jsxs(k0,{children:[l.jsx(S0,{type:"button",onClick:()=>t(),children:"Cancel"}),l.jsx(P0,{type:"submit",onClick:r,children:"Delete"})]})]})},T0=()=>l.jsx("div",{children:" Тут колись буде модалка TodayEditModal"}),$0=({handleAddWaterClick:e})=>{const{openModal:t}=d.useContext(tn),n=Xr().waterDayList,r=Ze();d.useEffect(()=>{r(io())},[r]);const o=i=>{t(l.jsx(l.Fragment,{children:l.jsx(M0,{id:i})}))},s=i=>{t(l.jsx(l.Fragment,{children:l.jsx(T0,{portion:i})}))};return l.jsxs(d0,{children:[l.jsx("h3",{children:"Today"}),n&&n.length>0&&l.jsx(f0,{children:n.map(i=>l.jsxs("li",{children:[l.jsxs(h0,{children:[l.jsx(m0,{}),l.jsx(p0,{children:`${i.waterVolume} ml `}),l.jsx("span",{children:i0(i.dateAdded,!0)})]}),l.jsxs(x0,{children:[l.jsx(b0,{onClick:()=>s(i),children:l.jsx(g0,{})}),l.jsx(v0,{onClick:()=>o(i._id),children:l.jsx(y0,{})})]})]},i._id))}),l.jsxs(w0,{onClick:e,children:[l.jsx(Vr,{})," Add water"]})]})},O0=y.div`
...
`,V0=y.svg`
  background-color:;
`,Q0=({onClose:e})=>{const t=Ze(),{user:n}=en(),r={weight:.03,activity:.04},o={weight:.04,activity:.06},[s,i]=d.useState(r),[a,c]=d.useState(""),[u,h]=d.useState(""),[p,f]=d.useState(""),v=n.waterRate;d.useEffect(()=>{const w=g=>{g.code==="Escape"&&e()};return window.addEventListener("keydown",w),()=>{window.removeEventListener("keydown",w)}},[e]);const x=d.useCallback(()=>!a||!u?void 0:(a*s.weight+u/60*s.activity).toFixed(1),[s,a,u]),m=d.useMemo(()=>x(),[x]),E=w=>{const g=w.target.value,S=parseFloat(g);!isNaN(S)&&S>=1?f(S):g===""&&f("")},P=w=>{w.preventDefault();const g=parseFloat(m);if(!(u>0&&a>0||p>0)){alert("Fill all fields");return}(isNaN(g)||g<=0)&&alert("Enter a valid intake goal"),t(ao(p||g)).then(k=>{k.error?(console.log(k.error),alert("Something went wrong ")):(e(),c(""),h(""),f(""))})};return l.jsx(_0,{children:l.jsxs(W0,{children:[l.jsxs(U0,{children:[l.jsx(A0,{children:"My daily norma"}),l.jsx(K0,{onClick:()=>e(),children:l.jsx(V0,{width:"24",height:"24",children:l.jsx("path",{d:"M6 18L18 6M6 6L18 18",stroke:"#407BFF",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})})})]}),l.jsxs(N0,{children:[l.jsxs(xe,{children:["For girl: ",l.jsx(ar,{children:"V=(M*0,03) + (T*0,4)"})]}),l.jsxs(xe,{children:["For man: ",l.jsx(ar,{children:"V=(M*0,04) + (T*0,6)"})]})]}),l.jsx(F0,{children:l.jsxs(I0,{children:[l.jsx(L0,{children:"*"})," V is the volume of the water norm in liters per day, M is your body weight, T is the time of active sports, or another type of activity commensurate in terms of loads (in the absence of these, you must set 0)"]})}),l.jsxs(z0,{children:[l.jsxs(H0,{children:[l.jsx(cr,{children:"Calculate your rate:"}),l.jsxs(B0,{children:[l.jsxs(lr,{children:[l.jsx(ur,{type:"radio",name:"gender",value:"woman",onChange:()=>i(r)}),l.jsx(xe,{children:"For woman"})]}),l.jsxs(lr,{children:[l.jsx(ur,{type:"radio",name:"gender",value:"man",onChange:()=>i(o)}),l.jsx(xe,{children:"For man"})]})]}),l.jsxs(dr,{children:[l.jsx(xe,{children:"Your weight in kilograms:"}),l.jsx(Kt,{type:"number",name:"userWeight",placeholder:"0",value:a,min:0,max:250,onChange:w=>c(w.target.value)})]}),l.jsxs(dr,{children:[l.jsx(xe,{children:"The time of active participation in sports or other activities with a high physical. load in hours:"}),l.jsx(Kt,{type:"number",name:"userActive",placeholder:"0",value:u,min:0,onChange:w=>h(w.target.value)})]}),l.jsxs(xe,{children:["The required amount of water in liters per day:",l.jsxs(X0,{children:[" ",m||(v/1e3).toFixed(1)," L"]})]})]}),l.jsxs(Y0,{children:[l.jsx(cr,{children:"Write down how much water you will drink:"}),l.jsx(Kt,{type:"number",name:"userWaterPredict",placeholder:"0",value:p,min:0,onChange:E})]}),l.jsx(G0,{children:l.jsx(q0,{onClick:P,children:"Save"})})]})]})})},J0=()=>{const[e,t]=d.useState(!1),{user:n}=en(),r=n.waterRate,o=()=>{t(!0)},s=()=>{t(!1)},i=(r/1e3).toFixed(1);return l.jsxs(O0,{children:[l.jsx(j0,{children:"My daily norma"}),l.jsxs(C0,{children:[l.jsxs(D0,{children:[" ",i||r," L"]}),l.jsx(R0,{onClick:o,children:"Edit"})]}),e&&l.jsx(Q0,{onClose:s})]})},Z0=y.div`
  display: flex;
  flex-direction: column;
`,eu=y.h3`
  margin-bottom: 24px;
