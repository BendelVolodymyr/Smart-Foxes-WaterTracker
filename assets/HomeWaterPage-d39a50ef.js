...
`;function na(e){const t=e.getFullYear(),n=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0");return`${t}-${n}-${r}`}const Tt=({portion:e})=>{const t=ge(),[n,r]=l.useState(0),[o,s]=l.useState(e?e.waterVolume:0),[i,u]=l.useState(ve(e?e.dateAdded:new Date)),[d,f]=l.useState(""),[p,g]=l.useState(""),[v,k]=l.useState(!1),{closeModal:x}=l.useContext(xe),{waterDayList:j}=me(),y=j||[],w=E=>{const D=parseFloat(E.target.value),H=Math.round(D);s(H)},m=()=>{k(!0),f(""),g("")},h=()=>{k(!1),r(o)},b=E=>{switch(E.currentTarget.id){case"increment":{const D=Math.min(o+50,3e3);s(D),r(D);break}case"decrement":{const D=o>0?o-50:0;s(D),r(D);break}}},P=async E=>{E.preventDefault();const B=na(new Date)+"T"+i,F=new Date(B).toISOString();if(!o||o<50){g("Please enter the amount of water consumed.");return}if(o>3e3){g("Maximum allowed is 3000 ml.");return}if(e){const A={id:e._id,date:F,waterVolume:n};await t(It(A)),s(0),x(),t(Pe())}else{if(y?y.find(L=>L.dateAdded===F):F){f(" A portion already exists for this time.");return}await t(Yt({waterVolume:n,date:F})),s(0),x(),t(Pe())}},O=e?"Edit the entered amount of water":"Add water",R=e?"Correct entered data: ":"Choose a value:";return a.jsxs(No,{children:[a.jsx(zo,{children:O}),e&&a.jsxs(ta,{children:[a.jsx($t,{}),a.jsx(Et,{children:`${e.waterVolume} ml `}),a.jsx("span",{children:ve(e.dateAdded,!0)})]}),y.length===0&&a.jsx("p",{children:"No notes yet"}),a.jsxs(Lo,{children:[a.jsx(Ho,{children:R}),a.jsxs(Ao,{children:[a.jsx(Yo,{children:"Amount of water:"}),a.jsxs(Io,{children:[a.jsx(ut,{onClick:b,id:"decrement",children:a.jsx(Zo,{})}),a.jsxs(Qo,{children:[" ",o||0," ml"]}),a.jsx(ut,{onClick:b,id:"increment",children:a.jsx(Jo,{})})]})]})]}),a.jsxs(Bo,{children:[a.jsx(_o,{children:"Recording time:"}),a.jsx(qo,{type:"time",value:i,onChange:E=>u(E.target.value)}),d&&a.jsxs(ht,{children:["⚠ ",d]})]}),a.jsxs(Uo,{children:[a.jsx(Vo,{children:"Enter the value of the water used:"}),a.jsx(Go,{name:"waterUsed",type:"number",step:50,value:o,onChange:w,onFocus:m,onBlur:h,pattern:"[0-9]{1,4}",max:3e3,required:!0}),p&&a.jsxs(ht,{hideonerror:v,children:[" ⚠ ",p]})]}),a.jsxs(Xo,{children:[a.jsxs(ea,{children:[" ",n||0," ml"]}),a.jsx(Ko,{onClick:P,children:"Save"})]})]})},ra=({handleAddWaterClick:e})=>{const{openModal:t}=l.useContext(xe),n=me().waterDayList,r=ge();l.useEffect(()=>{r(Pe())},[r]);const o=i=>{t(a.jsx(a.Fragment,{children:a.jsx(ko,{id:i})}))},s=i=>{t(a.jsx(a.Fragment,{children:a.jsx(Tt,{portion:i})}))};return a.jsxs(To,{children:[a.jsx("h3",{children:"Today"}),n&&n.length>0&&a.jsx(jo,{children:n.map(i=>a.jsxs("li",{children:[a.jsxs(Mt,{children:[a.jsx($t,{}),a.jsx(Et,{children:`${i.waterVolume} ml `}),a.jsx("span",{children:ve(i.dateAdded,!0)})]}),a.jsxs(Co,{children:[a.jsx(Oo,{onClick:()=>s(i),children:a.jsx(Do,{})}),a.jsx(Ro,{onClick:()=>o(i._id),children:a.jsx(Wo,{})})]})]},i._id))}),a.jsxs(Fo,{onClick:e,children:[a.jsx(St,{})," Add water"]})]})},oa=c.div`
...
`;c.svg`
  background-color:;
`;const Ma=()=>{const e=ge(),{user:t}=Se(),n={weight:.03,activity:.04},r={weight:.04,activity:.06},[o,s]=l.useState(r),[i,u]=l.useState(""),[d,f]=l.useState(""),[p,g]=l.useState(""),v=t.waterRate,{closeModal:k}=l.useContext(xe),x=l.useCallback(()=>!i||!d?void 0:(i*o.weight+d/60*o.activity).toFixed(1),[o,i,d]),j=l.useMemo(()=>x(),[x]),y=m=>{const h=m.target.value,b=parseFloat(h);!isNaN(b)&&b>=1?g(b):h===""&&g("")},w=m=>{m.preventDefault();const h=parseFloat(j);if(!(d>0&&i>0||p>0)){alert("Fill all fields");return}e(Bt(p||h)).then(P=>{P.error?(console.log(P.error),alert("Something went wrong ")):(k(),u(""),f(""),g(""))})};return a.jsxs(la,{children:[a.jsx(ka,{children:a.jsx(da,{children:"My daily norma"})}),a.jsxs(ua,{children:[a.jsxs(oe,{children:["For girl: ",a.jsx(ft,{children:"V=(M*0,03) + (T*0,4)"})]}),a.jsxs(oe,{children:["For man: ",a.jsx(ft,{children:"V=(M*0,04) + (T*0,6)"})]})]}),a.jsx(fa,{children:a.jsxs(ma,{children:[a.jsx(pa,{children:"*"})," V is the volume of the water norm in liters per day, M is your body weight, T is the time of active sports, or another type of activity commensurate in terms of loads (in the absence of these, you must set 0)"]})}),a.jsxs(ga,{children:[a.jsxs(wa,{children:[a.jsx(mt,{children:"Calculate your rate:"}),a.jsxs(xa,{children:[a.jsxs(pt,{children:[a.jsx(gt,{type:"radio",name:"gender",value:"woman",onChange:()=>s(n),checked:!0}),a.jsx(oe,{children:"For woman"})]}),a.jsxs(pt,{children:[a.jsx(gt,{type:"radio",name:"gender",value:"man",onChange:()=>s(r)}),a.jsx(oe,{children:"For man"})]})]}),a.jsxs(xt,{children:[a.jsx(oe,{children:"Your weight in kilograms:"}),a.jsx(He,{type:"number",name:"userWeight",placeholder:"0",value:i,min:0,max:250,onChange:m=>u(m.target.value)})]}),a.jsxs(xt,{children:[a.jsx(oe,{children:"The time of active participation in sports or other activities with a high physical. load in hours:"}),a.jsx(He,{type:"number",name:"userActive",placeholder:"0",value:d,min:0,onChange:m=>f(m.target.value)})]}),a.jsxs(ha,{children:["The required amount of water in liters per day:",a.jsxs(Pa,{children:[" ",j||(v/1e3).toFixed(1)," L"]})]})]}),a.jsxs(ba,{children:[a.jsx(mt,{children:"Write down how much water you will drink:"}),a.jsx(He,{type:"number",name:"userWaterPredict",placeholder:"0",value:p,min:0,onChange:y})]}),a.jsx(va,{children:a.jsx(ya,{onClick:w,children:"Save"})})]})]})},Ea=({handleDailyNormaModal:e})=>{const{user:t}=Se(),n=t.waterRate,r=(n/1e3).toFixed(1);return a.jsxs(oa,{children:[a.jsx(sa,{children:"My daily norma"}),a.jsxs(aa,{children:[a.jsxs(ca,{children:[r||n," L"]}),a.jsx(ia,{onClick:e,children:"Edit"})]})]})};function $a(e){return wt({tag:"svg",attr:{viewBox:"0 0 24 24"},child:[{tag:"g",attr:{id:"Circle_Plus"},child:[{tag:"g",attr:{},child:[{tag:"path",attr:{d:"M15,12.5H12.5V15a.5.5,0,0,1-1,0V12.5H9a.5.5,0,0,1,0-1h2.5V9a.5.5,0,0,1,1,0v2.5H15A.5.5,0,0,1,15,12.5Z"},child:[]},{tag:"path",attr:{d:"M12,21.932A9.934,9.934,0,1,1,21.932,12,9.944,9.944,0,0,1,12,21.932ZM12,3.065A8.934,8.934,0,1,0,20.932,12,8.944,8.944,0,0,0,12,3.065Z"},child:[]}]}]}]})(e)}const Sa=c.input`
  // background: ${e=>e.theme.colors.secondary.color5};
...
`,Ca=({handleAddWaterClick:e,calcRange:t})=>a.jsxs(Ta,{children:[a.jsxs(ja,{children:[a.jsx(Da,{children:"Today"}),a.jsx(Sa,{type:"range",min:"0",max:"100",value:t||0,readOnly:!0})]}),a.jsxs(Wa,{onClick:e,children:[a.jsx(jt,{})," Add water"]})]}),Oa="/Smart-Foxes-WaterTracker/assets/botleHomeDesk-3ae51194.png",Ra="/Smart-Foxes-WaterTracker/assets/botlteHomeDesk2x-9a54d3e4.png",Fa="/Smart-Foxes-WaterTracker/assets/bottleHomeTab-0bf3952c.png",Na="/Smart-Foxes-WaterTracker/assets/bottleHomeTab2x-ed4a96a1.png",za="/Smart-Foxes-WaterTracker/assets/backgroundHomeMob-d1e9a558.png",Ha="/Smart-Foxes-WaterTracker/assets/backgroundHomeMob2x-089f92e0.png",La="/Smart-Foxes-WaterTracker/assets/bottleHomeMob-1cd9cdb8.png",Aa="/Smart-Foxes-WaterTracker/assets/bottleHomeMob2x-0e2d77ce.png",Ia=c.main`
display: flex;
flex-direction:column;
...
`,Ua=()=>{const{openModal:e}=l.useContext(xe),n=me().waterDayList.map(i=>i.percentage);let r=0;n.forEach(i=>{r+=i});const o=()=>{e(a.jsx(a.Fragment,{children:a.jsx(Tt,{})}))},s=()=>{e(a.jsx(a.Fragment,{children:a.jsx(Ma,{})}))};return a.jsxs(Ia,{children:[a.jsxs(Ya,{children:[a.jsx(Ea,{handleDailyNormaModal:s}),a.jsx(Ca,{handleAddWaterClick:o,calcRange:r})]}),a.jsxs(Ba,{children:[a.jsx(ra,{handleAddWaterClick:o}),a.jsx(xo,{})]})]})};export{Ua as default};
