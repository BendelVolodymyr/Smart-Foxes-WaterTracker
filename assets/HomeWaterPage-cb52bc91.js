...
`,jl=({selectedDate:e,selectedDayData:t})=>{const n=Pr(e,"MMMM"),r=e.getDate(),o=no().user.waterRate,i=o?(o/1e3).toFixed(1):"0",s=t?(t.waterRate/1e3).toFixed(1):i,a=t?t.percentagePerDay:"0",c=t?t.totalPortions:"0";return l.jsxs(Ol,{children:[l.jsxs($l,{children:[" ",r,", ",n]}),l.jsxs(Cl,{children:[l.jsxs(Kt,{children:["Daily Norma: ",l.jsxs("span",{children:[s," L"]})]}),l.jsxs(Kt,{children:["Fulfillment of the daily norm: ",l.jsxs("span",{children:[a,"%"]})]}),l.jsxs(Kt,{children:["How many servings of water: ",l.jsx("span",{children:c})]})]})]})},Rl=y.div`
  display: flex;
  flex-direction: column;
  width: 100%;
`,_l=y.div`
...
`,Il=e=>e.water.waterDayList,Ll=e=>e.water.waterMonthList,Bl=e=>e.water.waterRate,At=()=>{const e=It(Il),t=It(Ll),n=It(Bl);return{waterDayList:e,waterMonthList:t,waterRate:n}},zl=()=>{const[e,t]=d.useState(new Date),[n,r]=d.useState(e.getMonth()),[o,i]=d.useState(null),[s,a]=d.useState(null),c=mt(),u=At().waterMonthList,h=()=>{a(null)},p=!!s,f=p?"simple-popover":void 0;d.useEffect(()=>{const m=An(e),E=Wn(e);console.log("currentMonth",n),o===null&&c(ro({startDate:m,endDate:E}))},[n,c,e,o]);const v=(m,E)=>{t(E),a(m.currentTarget),i(E.getDate())},x=u&&u.find(m=>{const[E]=m.date.split(",");return parseInt(E)===e.getDate()});return l.jsxs(Rl,{children:[l.jsxs(_l,{children:[l.jsx("h3",{children:"Month"}),l.jsx(Hi,{selectedDate:e,setSelectedDate:t,setCurrentMonth:r,setSelectedDay:i})]}),l.jsx(Dl,{children:Ao({start:An(e),end:Wn(e)}).map((m,E)=>{const k=m.getDate(),w=u.find(S=>{const[P]=S.date.split(",");return parseInt(P)===k}),g=w?w.percentagePerDay:null;return l.jsxs(Wl,{onClick:S=>v(S,m),children:[l.jsx(Al,{percentage:g,children:l.jsx(Fl,{children:k})}),l.jsxs(Nl,{children:[g||0,"%"]})]},E)})}),l.jsx(Tl,{id:f,open:p,anchorEl:s,onClose:h,anchorOrigin:{vertical:"top",horizontal:"left"},transformOrigin:{vertical:"bottom",horizontal:"right"},children:l.jsx(jl,{selectedDate:e,selectedDayData:x})})]})},Hl=y.div`
display: flex;
flex-direction:column;
